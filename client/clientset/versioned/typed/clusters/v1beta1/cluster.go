...
func newClusters(c *ClustersV1beta1Client, namespace string) *clusters {
	return &clusters{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *clusters) Apply(ctx context.Context, cluster *clustersv1beta1.ClusterApplyConfiguration, opts v1.ApplyOptions) (result *v1beta1.Cluster, err error) {
	if cluster == nil {

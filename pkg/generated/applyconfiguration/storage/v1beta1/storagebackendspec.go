...
// apply.
func StorageBackendSpec() *StorageBackendSpecApplyConfiguration {
	return &StorageBackendSpecApplyConfiguration{}
}
...
func (b *StorageBackendSpecApplyConfiguration) WithEndpoints(values ...string) *StorageBackendSpecApplyConfiguration {
	for i := range values {

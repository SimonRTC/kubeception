...
type NodeInterface interface {
	...
	Apply(ctx context.Context, node *nodesv1beta1.NodeApplyConfiguration, opts v1.ApplyOptions) (result *v1beta1.Node, err error)
	NodeExpansion
}
...
func newNodes(c *NodesV1beta1Client, namespace string) *nodes {
	return &nodes{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *nodes) Apply(ctx context.Context, node *nodesv1beta1.NodeApplyConfiguration, opts v1.ApplyOptions) (result *v1beta1.Node, err error) {
	if node == nil {

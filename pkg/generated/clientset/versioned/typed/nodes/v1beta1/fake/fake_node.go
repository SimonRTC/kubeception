...
func (c *FakeNodes) Apply(ctx context.Context, node *nodesv1beta1.NodeApplyConfiguration, opts v1.ApplyOptions) (result *v1beta1.Node, err error) {
	if node == nil {
	...
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(nodesResource, c.ns, *name, types.ApplyPatchType, data), &v1beta1.Node{})

...
// StorageV1beta1Client is used to interact with features provided by the storage.kubeception.io group.
type StorageV1beta1Client struct {
	restClient rest.Interface
}

func (c *StorageV1beta1Client) StorageBackends(namespace string) StorageBackendInterface {
	return newStorageBackends(c, namespace)
}

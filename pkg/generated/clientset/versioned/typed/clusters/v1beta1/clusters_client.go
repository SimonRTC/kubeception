...
// ClustersV1beta1Client is used to interact with features provided by the clusters.kubeception.io group.
type ClustersV1beta1Client struct {
	restClient rest.Interface
}

func (c *ClustersV1beta1Client) Clusters(namespace string) ClusterInterface {
...
// NewForConfigAndClient creates a new ClustersV1beta1Client for the given config and http client.
// Note the http client provided takes precedence over the configured transport values.
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*ClustersV1beta1Client, error) {
	config := *c
	if err := setConfigDefaults(&config); err != nil {
		return nil, err
	}
	...
	return &ClustersV1beta1Client{client}, nil
}
...
func New(c rest.Interface) *ClustersV1beta1Client {
	return &ClustersV1beta1Client{c}
}

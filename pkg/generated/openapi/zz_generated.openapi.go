...
func schema_kubeception_apis_clusters_v1beta1_Cluster(ref common.ReferenceCallback) common.OpenAPIDefinition {
...
func schema_kubeception_apis_clusters_v1beta1_ClusterCondition(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
...
func schema_kubeception_apis_clusters_v1beta1_ClusterList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("github.com/SimonRTC/kubeception/apis/clusters/v1beta1.Cluster"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/SimonRTC/kubeception/apis/clusters/v1beta1.Cluster", "k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta"},
	}
}

func schema_kubeception_apis_clusters_v1beta1_ClusterSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
...
func schema_kubeception_apis_clusters_v1beta1_ClusterStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "ClusterStatus represents the current state of a cluster.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"conditions": {
						...
						SchemaProps: spec.SchemaProps{
							Description: "The latest available observations of an object's current state. When a Cluster fails, one of the conditions will have type \"Failed\" and status true. When a Cluster is suspended, one of the conditions will have type \"Suspended\" and status true; when the Cluster is resumed, the status of this condition will become false.",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("github.com/SimonRTC/kubeception/apis/clusters/v1beta1.ClusterCondition"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/SimonRTC/kubeception/apis/clusters/v1beta1.ClusterCondition"},
	}
}
...
func schema_kubeception_apis_storage_v1beta1_StorageBackendCertificates(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					"ca": {
						SchemaProps: spec.SchemaProps{
							Description: "Certificate Authority used to secure etcd communication.",
							Default:     "",
							Type:        []string{"string"},
							Format:      "",
						},
					...
					"cert": {
						SchemaProps: spec.SchemaProps{
							Description: "Certification file used to secure etcd communication.",
							Default:     "",
							Type:        []string{"string"},
							Format:      "",
						},
					...
					"key": {
						SchemaProps: spec.SchemaProps{
							Description: "Private key used to secure etcd communication.",
							Default:     "",
							Type:        []string{"string"},
							Format:      "",
						},
				...
				Properties: map[string]spec.Schema{
					...
					"certificates": {
						SchemaProps: spec.SchemaProps{
							Description: "Certificates used to secure etcd communication.",
							Default:     map[string]interface{}{},
							Ref:         ref("github.com/SimonRTC/kubeception/apis/storage/v1beta1.StorageBackendCertificates"),
						},
					},
				},
			},

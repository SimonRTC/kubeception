	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.NodesV1beta1().NodePools(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.NodesV1beta1().NodePools(namespace).Watch(context.TODO(), options)
			},
		},
		&nodesv1beta1.NodePool{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *nodePoolInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&nodesv1beta1.NodePool{}, f.defaultInformer)
}

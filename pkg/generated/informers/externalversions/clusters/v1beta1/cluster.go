...
import (
	...
	v1beta1 "github.com/SimonRTC/kubeception/pkg/generated/listers/clusters/v1beta1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ClustersV1beta1().Clusters(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ClustersV1beta1().Clusters(namespace).Watch(context.TODO(), options)
			},
		},
		&clustersv1beta1.Cluster{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *clusterInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&clustersv1beta1.Cluster{}, f.defaultInformer)
}

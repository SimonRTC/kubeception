...
type NodePool struct {
	...
	// Specification of the desired behavior of a NodePool.
	// +optional
...
type Node struct {
	...
	// Specification of the desired behavior of a node.
	// +optional
